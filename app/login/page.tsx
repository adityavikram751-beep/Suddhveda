...
function LoginForm() {
  ...
  return (
    <>
      {/* Global reset – body margin hatao, full height set karo */}
      <style
      ...
      <main className="h-screen w-full bg-[#FFF8EF] overflow-hidden">
        <div className="grid h-full w-full grid-cols-1 bg-white lg:grid-cols-2">
          ...
          {/* Form Column – full height, scroll agar content zyada ho to */}
          <div className="flex h-full items-center justify-center overflow-y-auto bg-[#FFFEFC] px-5 py-6 sm:px-8 lg:px-12">
            <div className="w-full max-w-[430px]">
              <div className="text-center">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-[#F2D6A7] bg-white text-[#E69A00]">
                  <ShieldCheck size={22} />
                </div>
                <h1 className="font-serif text-3xl font-bold text-[#2D2118] sm:text-4xl">
                  {title}
                </h1>
                <p className="mx-auto mt-2 max-w-[320px] text-sm leading-5 text-[#7C8797]">
                  {subtitle}
                </p>
              </div>

              <form
                onSubmit={step === "details" ? submitDetails : submitOtp}
              ...
              >
                  ...
                  <label className="block">
                    ...
                    <div className="relative mt-1.5">
                      ...
                      <input
                        ...
                        className="h-11 w-full rounded-lg border border-[#E6EAF0] bg-white pl-12 pr-4 text-sm text-[#2D2118] outline-none transition placeholder:text-[#C0C8D2] focus:border-[#E69A00] focus:ring-2 focus:ring-[#E69A00]/20"
                      />
                    </div>
                  </label>
                )}
                ...
                {message && (
                  <p className="flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-3 py-1.5 text-sm text-green-700">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="h-11 w-full rounded-lg bg-[#E69A00] text-sm font-bold text-white shadow-[0_12px_24px_rgba(230,154,0,0.25)] transition hover:bg-[#C98715] disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {buttonLabel}
                </button>
              </form>
              ...
              {step === "details" && mode === "login" && (
                <button
                  ...
                  className="mx-auto mt-6 flex items-center justify-center text-sm font-bold text-[#0B6B3A] hover:underline"
                >
              ...
              {step === "details" && mode === "signup" && (
                <button
                  ...
                  className="mx-auto mt-6 flex items-center gap-2 text-sm font-bold text-[#0B6B3A] hover:underline"
                >
                  <ArrowLeft size={16} />
                  Back to Sign In
                </button>
              ...
              <div className="mx-auto mt-6 flex max-w-[260px] items-center gap-4 text-[#D8C0A0]">
                <span className="h-px flex-1 bg-current" />
                <Leaf size={17} className="text-[#D88217]" />
                <span className="h-px flex-1 bg-current" />
              </div>
              <p className="mt-4 flex items-center justify-center gap-2 text-xs font-medium text-[#667085]">
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <main className="flex h-screen items-center justify-center bg-[#FFF8EF]">
