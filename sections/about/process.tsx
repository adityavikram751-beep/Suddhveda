      ...
      <div className="max-w-[1450px] mx-auto w-full px-5 sm:px-8 relative z-10">
        ...
        <div className="mt-10">
          ...
          <div className="hidden lg:block relative min-w-0 overflow-x-auto py-4">
            {/* ONE continuous dashed line running behind all cards - PERFECTLY CENTERED AT 78PX */}
            <div className="absolute top-[78px] left-[8.33%] right-[8.33%] border-t-2 border-dashed border-[#D49313]/70 -translate-y-1/2 pointer-events-none z-0" />

            <div className="grid grid-cols-6 gap-6 relative z-10">
              {steps.map((item) => (
                <div key={item.title} className="flex flex-col items-center text-center group cursor-pointer">
                  {/* Step Number Badge */}
                  <span className="bg-gradient-to-r from-[#D49313] to-[#593102] text-white font-extrabold text-[11px] tracking-wider uppercase px-2.5 py-0.5 rounded-full shadow-xs mb-2.5 z-10">
                    STEP {item.step}
                  </span>
